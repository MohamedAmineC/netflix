...
const Input:React.FC<inputProps> = ({id,value,onChange,label,type}) => {
  return (
    <div className='relative'>
        ...
        onChange={onChange}
        />
        <label htmlFor={id} className='absolute text-md text-zinc-400 duration-150 transform -translate-y-3 scale-75 top-4 z-10 origin-[0] left-6 peer-placeholder-shown:scale-100 
